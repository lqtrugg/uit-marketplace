  ...
  return (
    <section className="app-container py-10">
      <article className="mx-auto w-full max-w-2xl rounded-2xl border border-clicon-border bg-white p-6 shadow-card sm:p-8">
        <PageHero
          iconSrc="/clicon/image/svg/calendar-2.svg"
          title="Order Successful"
          subtitle={`Your dummy deposit has been confirmed.${referenceId ? ` Reference: ${referenceId}.` : ''}${hasItemId ? ` Item ID: #${itemId}.` : ''}`}
        />
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          >
            <img src="/clicon/image/svg/clock.svg" alt="" className="size-4" />
